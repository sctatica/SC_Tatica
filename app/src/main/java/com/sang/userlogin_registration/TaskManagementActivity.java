...
public class TaskManagementActivity extends AppCompatActivity {
    ...
    private class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getResources().getText(R.string.task_in_duration);
                case 1:
                    return getResources().getText(R.string.task_end_duration);
            }
            return null;
        }
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(TaskManagementActivity.this, HomeActivity.class);
